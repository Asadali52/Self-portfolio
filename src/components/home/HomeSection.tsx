  ...
  return (
    ...
    >
      ...
      <div className={`mt-4 flex gap-3 relative ${secialIconsClass}`}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="bg-white rounded-[3px] cursor-pointer" viewBox="0 0 256 256">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256" className="cursor-pointer">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" className="cursor-pointer">
