...
const HowManyProjectsIWorked = () => {
  ...
  const targets = useMemo(() => [132, 221, 1453, 7], []);
  const durations = useMemo(() => [1000, 1200, 1500, 4000], []);
    ...
    <div>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Passionate about creating exceptional digital experiences, I&apos;ve dedicated myself to mastering 
          modern web technologies and delivering innovative solutions that drive business success.
        </p>
      </div>

      <div className="grid grid-cols-4 max-[1024px]:grid-cols-2 max-[768px]:grid-cols-1 gap-8" ref={elementRef}>
